...
import 'package:last_minute/helper/shared_preference.dart'; // Add Cloud Firestore package
  ...
  class _WalletState extends State<Wallet> {
    ...
    void _onServiceButtonPressed(String serviceName) async {
      ...
      if (serviceName == 'Get Code') {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => GeneratedQR(_rideFare.value)), // Change this line
        );
      }
